...
start)  # start [<clusterName>]
  ...
  TARGET="wordcount-result-1997"
  gcloud dataproc jobs submit hadoop --cluster "$CLUSTER" \
    --jar target/wordcount-mapreduce-0-SNAPSHOT-jar-with-dependencies.jar \
    -- wordcount-hbase \
    gs://dataproc-9eb81a36-e552-4513-bd31-2724813dbd0b-asia-southeast1/word-count-01.txt \
    gs://dataproc-9eb81a36-e552-4513-bd31-2724813dbd0b-asia-southeast1/word-count-02.txt \
    "${TARGET}"
    echo ""
    echo "Table ghi nhận kết quả là: ${TARGET}"
    echo ""
  ;;
